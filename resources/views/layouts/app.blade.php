    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">CODING</div>
            </a>
            ...
            <li class="nav-item {{ request()->is(['manajemen-pengguna']) ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('manajemen-pengguna.index') }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" type="button" data-toggle="modal" data-target="#edit-profile">
